...
var generateResume = function (event) {
    ...
    reader.onload = function (event) {
        ...
        currentResumeData = { name: name, email: email, phone: phone, dateOfBirth: dateOfBirth, profilePicture: profilePicture, jobTitle: jobTitle, company: company, duration: duration, degree: degree, institution: institution, year: year, professionalSkill: professionalSkill, softSkill: softSkill };
...
var editResume = function () {
    ...
    document.getElementById('addMoreSkills').value = currentResumeData.addMoreSkills;
};
// Event listeners
